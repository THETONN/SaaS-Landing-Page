"use client";
import ArrorIcon from "@/assets/icons/arrow-w.svg";
import curcorImage from "@/assets/images/cursor.png";
    ...
    <div className="bg-black text-white bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A46EDB_82%)] py-[72px] sm:py-24 relative overflow-clip">
      ...
      <div className="container relative">
        <div className="flex items-center justify-center">
          <a
            href="#"
            className="inline-flex gap-3 border bpy-1 px-2 rounded-lg border-white/30"
          >
          ...
          <div className="inline-flex relative">
            ...
            >
              <Image
                src={curcorImage}
                alt="curcorImage"
                className="h-[200px] w-[200px] max-w-none"
                draggable="false"
              />
            </motion.div>
            <motion.div className="absolute h-[200px] w-[200px] top-[56px] left-[498px] hidden sm:inline"
              drag
              dragSnapToOrigin
            >
              <Image
        ...
        <div className="flex justify-center">
          <p className="text-center text-xl mt-8 max-w-md">
            ...
            progress, motivation your efforts, and celebrate your successes.
          </p>
        </div>
        <div className="flex justify-center mt-8">
